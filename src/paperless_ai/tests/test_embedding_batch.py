...
class TestLiteLLMEmbeddingBatching(TestCase):
    ...
    def test_get_text_embeddings_batching(self, mock_aembedding):
        """
        ...
        self.assertEqual(len(mock_aembedding.call_args_list[0][1]["input"]), 4)
        # Second call should have 2 inputs
        self.assertEqual(len(mock_aembedding.call_args_list[1][1]["input"]), 2)
